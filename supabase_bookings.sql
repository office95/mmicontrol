...
create table if not exists public.bookings (
  ...
  booking_date date,
  amount numeric,
  status text check (status in ('offen','Anzahlung erhalten','abgeschlossen','Schlussrechnung versendet','Zahlungserinnerung','1. Mahnung','2. Mahnung','Inkasso','Storno','Archiv','uneinbringlich')) default 'offen',
