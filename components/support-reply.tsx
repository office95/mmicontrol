    ...
    <div className="space-y-3 bg-transparent border border-white/15 rounded-2xl p-4 text-white">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
        ...
        <div className="space-y-3">
          <div>
            <label className="text-xs uppercase tracking-[0.12em] text-white/70">Status</label>
          ...
          <div>
            <label className="text-xs uppercase tracking-[0.12em] text-white/70">Priorität</label>
