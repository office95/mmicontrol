...
export async function GET(req: Request) {
  ...
  let q = service.from('payments').select('id, booking_id, payment_date, amount, method, note, bank_fee, category, partner_id, invoice_number, created_at');
...
export async function POST(req: Request) {
  ...
  const { booking_id, payment_date, amount, method, note, bank_fee, category, partner_id, invoice_number } = body;
