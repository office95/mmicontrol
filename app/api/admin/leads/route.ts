...
const baseSelect =
  'id, lead_code, salutation, skills, requested_at, closed_at, updated_at, first_status_change_at, name, email, phone, country, state, interest_courses, interest_other, partner_id, source, source_note, lead_quality, newsletter, is_customer, status, notes, created_at, partner:partners(id,name)';
