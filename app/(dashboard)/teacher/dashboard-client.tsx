    ...
    <div className="min-h-screen flex flex-col space-y-8">
      <div className="flex-1 space-y-8">
        <nav className="sticky top-0 z-30 -mx-4 px-4 pt-3 pb-4">
          <div className="rounded-3xl border border-white/15 bg-slate-950/85 backdrop-blur-2xl shadow-[0_18px_52px_rgba(0,0,0,0.38)] px-3 py-3.5 flex flex-wrap items-center gap-2 sm:gap-3 text-sm font-semibold text-white/85 overflow-x-auto">
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'perf' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('perf')}
            >
              Performance-Übersicht
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'courses' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('courses')}
            >
              Meine Kurse & Teilnehmer
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'materials' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('materials')}
            >
              Kursunterlagen
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'feedback' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('feedback')}
            >
              Kurs-Feedback
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'benefits' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('benefits')}
            >
              Benefits
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'quiz' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
              onClick={() => setTab('quiz')}
            >
              Quiz
            </button>
            <button
              className={`px-3 py-2 rounded-full border transition ${tab === 'support' ? 'border-pink-300/80 bg-gradient-to-r from-pink-500/55 via-rose-500/50 to-amber-400/45 text-white shadow-[0_10px_30px_rgba(236,72,153,0.25)]' : 'border-white/15 bg-white/5 hover:border-pink-300 hover:text-white'}`}
