...
export default function TeacherSupportPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white px-4 sm:px-6 lg:px-10 py-6 space-y-6">
      ...
      <div className="flex flex-wrap gap-2 text-sm font-semibold">
        {[
          ...
          <a
            key={label}
            href={href}
            className={`px-3 py-2 rounded-lg border ${href === '/teacher/support' ? 'border-pink-300 bg-white/10 text-white' : 'border-white/20 bg-white/5 text-white/80 hover:border-pink-300 hover:text-white'}`}
          >
            {label}
          </a>
        ))}
